...
CREATE TABLE ATTENDENCE(
    ...
    FOREIGN KEY (PROJ_ID) REFERENCES USER (PROJ_ID),
...
CREATE TABLE COMMENT_BIG(
    BIGC_ID INT(11) UNSINGED AUTO_INCREMENT,
    BIG_ID INT(11) UNSINGED,
...
CREATE TABLE COMMENT_MID(
    MIDC_ID INT(11) UNSINGED AUTO_INCREMENT,
    MID_ID INT(11) UNSINGED,
...
CREATE TABLE COMMENT_SML(
    SMLC_ID INT(11) UNSINGED AUTO_INCREMENT,
    SML_ID INT(11) UNSINGED,
...
CREATE TABLE COMMENT_NOTI(
    NOTIC_ID INT(11) UNSINGED AUTO_INCREMENT,
    NOTI_ID INT(11) UNSINGED,
