...
CREATE VIEW POST_LIST AS
   select PB.BIG_ID, PB.PROJ_ID, PB.BIG_LEVEL, PB.BIG_TITLE, PB.BIG_START, PB.BIG_END, PB.BIG_DESC, PB.BIG_ATTACHMENT, PB.BIG_STATUS, PB.BIG_AUTHOR,  PB.BIG_CREATED,
         ...
         MIDJOIN.SML_ID, MIDJOIN.SML_TITLE, MIDJOIN.SML_START, MIDJOIN.SML_END, MIDJOIN.SML_DESC, MIDJOIN.SML_ATTACHMENT, MIDJOIN.SML_STATUS, MIDJOIN.SML_AUTHOR,  MIDJOIN.SML_CREATED
 from POST_BIG PB LEFT JOIN 
...
PS.SML_ID, PS.SML_TITLE, PS.SML_START, PS.SML_END, PS.SML_DESC, PS.SML_ATTACHMENT, PS.SML_STATUS, PS.SML_AUTHOR,  PS.SML_CREATED 
from POST_MID PM LEFT JOIN POST_SML PS ON PM.MID_ID = PS.MID_ID) AS MIDJOIN
